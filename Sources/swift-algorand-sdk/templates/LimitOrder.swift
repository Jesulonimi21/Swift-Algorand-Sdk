...
public class LimitOrder {
    ...
    public static  func  MakeLimitOrder(owner:Address,assetId:Int,ratn:Int,ratd:Int,expirationRound:Int,minTrade:Int,maxFee:Int) throws -> ContractTemplate {
        ...
        var values:[ContractTemplate.ParameterValue] = [ContractTemplate.IntParameterValue(offset: 5, value: maxFee),ContractTemplate.IntParameterValue(offset: 7, value: minTrade),ContractTemplate.IntParameterValue(offset: 9, value: assetId),ContractTemplate.IntParameterValue(offset: 10, value: ratd),ContractTemplate.IntParameterValue(offset: 11, value: ratn),ContractTemplate.IntParameterValue(offset: 12, value: expirationRound),ContractTemplate.AddressParameterValue(offset: 16, address: owner)]
